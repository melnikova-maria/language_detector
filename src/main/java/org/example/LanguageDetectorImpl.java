...
import org.example.cybozu.util.Util;
...
public final class LanguageDetectorImpl implements LanguageDetector {
    ...
    private double[] detectBlockShortText(Map<String, Integer> ngrams) {
        ...
        double alpha = this.alpha; //I don't understand what this does.
    ...
    private double[] initProbability() {
        ...
        if (priorMap != null) {
            ...
            Arrays.fill(prob, 1.0 / ngramFrequencyData.getLanguageList().size());
        }
        return prob;
    }
